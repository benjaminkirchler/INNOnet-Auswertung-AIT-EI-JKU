...
This repository provides a **reusable research project template** designed to:
...
├── paper/
│   ├── main.tex               # document structure
│   ├── preamble.tex           # packages, formatting, biblatex
│   ├── titlepage.tex          # authors and affiliations
│   ├── bibliography.bib       # Zotero auto-export (do not edit manually)
│   ├── sections/
│   │   ├── 01_abstract.tex
│   │   ├── 02_introduction.tex
│   │   ├── 03_literature.tex
...
│
├── R/                          # R scripts
├── masterfile.R               # runs full analysis pipeline
│
├── data/
...
│
├── OSF/                        # preregistration & OSF material
│
├── .gitignore
...
A new GitHub repository named `research-project-template` was created to serve as a reusable template for future research projects.

### Step 2 — Clone locally
The repository was cloned to a fixed local directory to ensure stable relative paths across machines.

### Step 3 — Create RStudio project
An `.Rproj` file was created inside the repository to support reproducible R workflows and Git integration.
...
Rules:
- Zotero writes the file
- the file is never edited manually
- citation keys are stable

### Step 6 — Commit to GitHub
All LaTeX files and the bibliography were committed, making GitHub the single source of truth.

### Step 7 — Import into Overleaf
A new Overleaf project was created by importing the GitHub repository.  
Overleaf is used only as an editor/compiler, not as the canonical file source.
